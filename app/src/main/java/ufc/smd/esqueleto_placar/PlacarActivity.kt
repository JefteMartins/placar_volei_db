...
class PlacarActivity : AppCompatActivity() {
    ...
    fun finalizarJogo(){
        ...
        var ganhadorString = voleiJogo.saveWinner()
    ...
    fun saveGame(v: View) {
        ...
        val dbUpdate = DatabaseController(baseContext)
        var resultado = "";
        resultado = dbUpdate.insertData(
            voleiConfig.nomePartida,
            voleiConfig.nomeTimeA,
            voleiConfig.nomeTimeB,
            voleiConfig.pontosPorSet,
            voleiJogo.quantidadeDeSetsParaGanharJogo,
            voleiJogo.saveWinner());
